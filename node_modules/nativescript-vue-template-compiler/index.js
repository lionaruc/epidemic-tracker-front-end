...
/*!
 * NativeScript-Vue-Template-Compiler v2.5.0
 * (Using Vue v2.6.10)
...
function add(event, handler, once, capture) {
  ...
  if (once) {
    ...
    handler = function () {
      ...
      if (res !== null) {
        remove$1(event, null, null, target);
      }
    };
  }
...
function remove$1(event, handler, capture, _target) {
...
var NS_VUE_VERSION = process.env.NS_VUE_VERSION || '2.5.0';
