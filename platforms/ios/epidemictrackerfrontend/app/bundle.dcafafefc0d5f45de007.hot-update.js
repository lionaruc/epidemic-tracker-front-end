    ...
    loadSummary() {
      ...
      Object(tns_core_modules_http__WEBPACK_IMPORTED_MODULE_0__["request"])({
        ...
        if (response.statusCode == 200) {
          this.summary = result;
          this.percentage = 6 - summary.latest_score_numeric / 100 * 6;
          this.percentageDescription = summary.latest_score_numeric;
        }
