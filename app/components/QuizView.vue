    ...
    <ScrollView style="margin-top: 11%">
      <StackLayout v-if="!processing && !completed">
        <StackLayout
          ...
          style="margin: 13; margin-left: 33; margin-right: 33; height: 33%; margin-top: 15%;"
        >
          <Label
            :text="(question.postion) + '. ' + question.question_text"
            textWrap="true"
            style="margin: 3; color: black;"
          />

          <ListPicker
            :items="question.display_answers"
            v-model="question.selectedIndex"
            style="margin: 5"
          />
        </StackLayout>

        <Button text="Submit" class="blue-button submit-btn" @tap="submit"></Button>
      </StackLayout>
